...
# 2. Инжектиране на компактни CSS стилове за събиране на страницата на един екран
st.markdown("""
    <style>
    .main { background-color: #1c1f26; }
    .block-container { padding-top: 0.5rem !important; padding-bottom: 0px !important; padding-left: 1.5rem !important; padding-right: 1.5rem !important; }
...
# 7. ОБЛАЧЕН ФРАГМЕНТ ЗА РЕАЛНО ВРЕМЕ (Изтичане на секундите всяка 1 секунда без лаг)
...
def display_dashboard():
    ...
    # Добавяне на нова свещ при изтичане на времевия отрязък
    if current_timestamp_bucket != st.session_state.last_update_timestamp:
        ...
        # Симулиране на текущ тик в рамките на свещта
        last_price = st.session_state.df_history["Price"].iloc[-1]
    ...
    # Калкулиране на индикаторите с подсигурен минимум
    ...
    # Калкулация за достоверност и сила на сигнала
    ...
    # --- ГОРЕН ПАНЕЛ (Двуколонен без часовник) ---
