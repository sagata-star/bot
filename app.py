...
# Модерен Неонов CSS дизайн за уеб терминала - Мащабиран за 1 екран
st.markdown(
    "<style>"
    ...
    "div[data-testid='stMetricValue'] { font-family: 'Courier New', monospace !important; font-size: 18px !important; font-weight: bold !important; color: #e2e8f0 !important; }"
...
# Пълен списък с всички 70+ актива от Pocket Option
all_otc_assets = [
